  ...
  <div>
    ...
    <div id="reportRepairTable">
      ...
      >
        ...
        <el-table-column prop="licensePlate" label="License Plate" align="center" width="150"></el-table-column>
        <el-table-column prop="parkingSpace" label="Parking Space" align="center" width="150"></el-table-column>
        <el-table-column prop="colour" label="Color" align="center" width="100"></el-table-column>
      </el-table>
    </div>
