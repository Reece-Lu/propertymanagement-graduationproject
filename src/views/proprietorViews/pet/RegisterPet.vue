  ...
  <div style="background-color: rgb(244, 244, 245); height: 100vh;">
    ...
    <van-form style="margin-top: 3vh" @submit="onSubmit">
      <van-cell-group inset>
        ...
        <van-field v-model="registerForm.petName" name="name" label="Pet Name"/>
        <van-field v-model="registerForm.age" name="age" label="Age"/>
        <van-field v-model="registerForm.species" name="species" label="Species"/>
      </van-cell-group>
